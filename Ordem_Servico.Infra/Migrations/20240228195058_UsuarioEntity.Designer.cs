...
namespace Ordem_Servico.Infra.Migrations
{
    ...
    [Migration("20240228195058_UsuarioEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Equipamento", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Finalizacao", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Ocorrencia", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.OrdemServico", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Peca", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Servico", b =>
                {
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Tecnico", b =>
                {
                    b.Property<int>("TecnicoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Usuario", b =>
                {
            ...
            modelBuilder.Entity("EquipamentoOrdemServico", b =>
                {
                    b.HasOne("Ordem_Servico.Domain.Entities.Equipamento", null)
                        .WithMany()
                        .HasForeignKey("EquipamentosEquipamentoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ordem_Servico.Domain.Entities.OrdemServico", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OcorrenciaOrdemServico", b =>
                {
                    b.HasOne("Ordem_Servico.Domain.Entities.Ocorrencia", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrdemServicoPeca", b =>
                {
                    ...
                    b.HasOne("Ordem_Servico.Domain.Entities.Peca", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrdemServicoServico", b =>
                {
                    ...
                    b.HasOne("Ordem_Servico.Domain.Entities.Servico", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.Finalizacao", b =>
                {
                    b.HasOne("Ordem_Servico.Domain.Entities.OrdemServico", "OrdemServico")
                        .WithOne("Finalizacao")
                        .HasForeignKey("Ordem_Servico.Domain.Entities.Finalizacao", "FinalizacaoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ordem_Servico.Domain.Entities.OrdemServico", b =>
                {
                    b.HasOne("Ordem_Servico.Domain.Entities.Cliente", "Cliente")
                        .WithMany("OrdemServicos")
                        .HasForeignKey("ClienteID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ordem_Servico.Domain.Entities.Tecnico", "Tecnico")
                        .WithMany("OrdemServicos")
